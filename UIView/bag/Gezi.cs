...
public class Gezi : MonoBehaviour {
    ...
    public void GetInObj(RectTransform obj,bool isChange = false,bool isOldObjOut = false)
    {
        ...
        */
        ...
        //改变徽章大小 与格子大小同步
        _obj.GetComponent<RectTransform>().sizeDelta = new Vector2(this.GetComponent<RectTransform>().sizeDelta.x * 0.94f, this.GetComponent<RectTransform>().sizeDelta.y * 0.94f);//this.GetComponent<RectTransform>().sizeDelta;
        _obj.GetComponent<RectTransform>().localScale = new Vector3(0.9f,0.9f,0.9f);
    }
